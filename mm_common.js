...
/***********************************************************************
  1. ¼³¸í : Text¿¡ ¿µ¹®ÀÚ ¼Ò¹®ÀÚ¸¦ ´ë¹®ÀÚ·Î ¹Ù²ãÁØ´Ù.
************************************************************************/
...
/***********************************************************************
  1. ¼³¸í : Text¿¡ ¿µ¹®ÀÚ ´ë¹®ÀÚ¸¦ ¼Ò¹®ÀÚ·Î ¹Ù²ãÁØ´Ù.
************************************************************************/
...
/************************************************************************************
 ...
 js_DateType() : ³â¿ùÀÏÀÌ °°ÀÌ ÀÖ´Â Input box »ó¿¡¼­ ³â¿ùÀÏÀ» Ã¼Å©ÇÏ´Â ÇÔ¼ö
                    ¹°·Ð ÀÎÀÚ°ªÁß¿¡¼­ typeÀ¸·Î ³â¿ùÀÏÀÇ ±¸ºÐÀÚ¸¦ ¼±ÅÃÇÒ ¼ö ÀÖ´Ù.
                    js_js_DateType(this, "/") | 20000101-->2000/01/01

 »ç¿ë¿¹      : <input ... onblur = "js_js_DateType(this, "/")">
...
/************************************************************************************
20021113 Ãß°¡
 js_js_DateType2()      : ³âµµ¸¸ ÀÔ·ÂÇÏ°ÔÇÏ´Â ÇÔ¼ö

 »ç¿ë¿¹                 : <input ... onKeypress = "js_js_DateType2(this)">
...
function js_DateType2(obj)
{
    ...
    {
        alert("³âµµ Çü½ÄÀº YYYYÀÔ´Ï´Ù.");
        obj.value = "";
        obj.focus();
        return false;
    }
    if (isNaN(Number(obj.value))) {
        alert("³âµµ´Â ¼ýÀÚ¸¸ ÀÔ·ÂÇÏ¼Å¾ß ÇÕ´Ï´Ù.");
        obj.value = "";
        obj.focus();
    }
    return true;
...
/************************************************************************************
20021210 Ãß°¡
 js_js_DateType3()      : ³â¿ù¸¸ ÀÔ·ÂÇÏ°ÔÇÏ´Â ÇÔ¼ö

 »ç¿ë¿¹                 : <input ... onKeypress = "js_js_DateType3(this)">
...
//   var sFormat="YYYYMMDD";
   ...
   if (sDate.length != 6 )
   {
        alert("Àß¸ø ÀÔ·ÂÇÏ¿´½À´Ï´Ù.\nÀÔ·ÂÇü½ÄÀº YYYYMMÀÔ´Ï´Ù.");
        obj.value="";
        obj.focus();
        return ;
   }
   else
   {
        ...
        {
            alert("Àß¸ø ÀÔ·ÂÇÏ¼Ì½À´Ï´Ù. ´Ù½Ã È®ÀÎÇÏ½Ê½Ã¿ä");
            obj.value="";
            obj.focus();
            return;
        }
...
/************************************************************************************
2003-03-25 Ãß°¡
 js_CheckTel(this)      : ¼ýÀÚ¿Í ')' ,'-'¸¦ ÀÔ·ÂÇÏ±â À§ÇÑ ÇÔ¼ö

 »ç¿ë¿¹                 : <input ... onBlur = "js_CheckTel(this)">
...
/************************************************************************************
2003-03-25 Ãß°¡
 js_OnlyNumber4()       : ¼ýÀÚ¿Í'-'¸¦ ÀÔ·ÂÇÏ±â À§ÇÑ ÇÔ¼ö

 »ç¿ë¿¹                 : <input ... onKeypress = "js_OnlyNumber4(this)">
...
/************************************************************************************
2003-03-25 Ãß°¡
 js_PostCheck()     : ¼ýÀÚ¿Í'-'¸¦ ÀÔ·ÂÇÏ±â À§ÇÑ ÇÔ¼ö

 »ç¿ë¿¹                 : <input ... onKeypress = "js_js_OnlyNumber4(this)">
...
function js_PostCheck(obj)
{
   ...
   if (!isNum(result)) {
      alert("¿ìÆí¹øÈ£´Â ¼ýÀÚ¸¸ ÀÔ·ÂÇÏ¼Å¾ß ÇÕ´Ï´Ù.");
      obj.value = "";
      obj.focus();
   }
   else if (result.length !== 6 ){
      alert("¿ìÆí¹øÈ£´Â 6ÀÚ¸®·Î ÀÔ·ÂÇÏ¼Å¾ß ÇÕ´Ï´Ù.('-'Á¦¿Ü)");
      obj.value = "";
      obj.focus();
   }
   else {
...
//          alert(mForm.elements[i].name);
        if (mForm.elements[i].type == "text" && mForm.elements[i].getAttribute("mandatory") != null)
        {
            ...
            if(eval(mForm.elements[i].getAttribute("mandatory"))=='0' && mForm.elements[i].value.length == 0)
            {
                alert(mForm.elements[i].getAttribute("mandatoryName") +"´Â ÇÊ¼ö¼±ÅÃ»çÇ× ÀÔ´Ï´Ù.");
                mForm.elements[i].focus();
                return 0;
            }
...
/************************************************************************************
 ...
 js_js_DateType() : ³â¿ùÀÏÀÌ °°ÀÌ ÀÖ´Â Input box »ó¿¡¼­ ³â¿ùÀÏÀ» Ã¼Å©ÇÏ´Â ÇÔ¼ö
                    ¹°·Ð ÀÎÀÚ°ªÁß¿¡¼­ typeÀ¸·Î ³â¿ùÀÏÀÇ ±¸ºÐÀÚ¸¦ ¼±ÅÃÇÒ ¼ö ÀÖ´Ù.
                    js_js_DateType(this, "/") | 20000101-->2000/01/01
...
/*************************************************************************
  1. ¼³¸í : Çü½ÄÈ­µÈ ³»¿ëÀÇ ½Éº¼µéÀ» ¾ø¾Ö°í ¿ø·¡ÀÇ ³»¿ë¸¸À» º¸¿©ÁØ´Ù.
    2. ÀÔ·ÂÇ×¸ñ(Parameter)
            - v  : ÀÔ·ÂÇÊµå¿¡ ÀÔ·ÂÇÑ String °ª.
            - sep   : »èÁ¦ÇÏ°íÀÚÇÏ´Â ½Éº¼
*************************************************************************/
...
/*************************************************************************
  1. ¼³¸í : Áß¾Ó¿¡ »õ·Î¿î À©µµ¿ì »ý¼º.
    2. ÀÔ·ÂÇ×¸ñ(Parameter)
            - url : ¸µÅ©Á¤º¸
            - name : »õ·Î¿î À©µµ¿ì name
            - width : À©µµ¿ì³ÐÀÌ
            - height : À©µµ¿ì ³ôÀÌ
            - scrollbars : ¾øÀ½
************************************************************************/
...
/************************************************************************************
 ...
 Checking()     : CheckBox¸¦ Checking ÇÏ´Â ÇÔ¼ö.
...
/*
¸®½ºÆ®¿¡¼­ Ã¼Å©µÇ¾îÀÖ´Â Ç×¸ñ¿¡ Ã¼Å©¸¦ À¯ÁöÇÏ°Ô ÇØÁÖ´Â ¸Þ¼Òµå
*/
...
function doMutiDel(ServletPath,CheckData,FormName){
    ...
    if( count != 0 ){
        if( !confirm( count + "°³ Ç×¸ñÀ» »èÁ¦ÇÏ½Ã°Ú½À´Ï±î?") ){
            return false;
        }
...
/************************************************************************************
 ...
 doCancelMuti()     : doCancelMuti ÇÏ´Â ÇÔ¼ö.
...
function doCancelMuti(ServletPath,CheckData,FormName){
    ...
    if( count != 0 ){
        if( !confirm( count + "°³ Ç×¸ñÀ» Ãë¼ÒÇÏ½Ã°Ú½À´Ï±î?") ){
            return false;
        }
        js_CenterNewWin2("", "_new", 400, 300);
        frm.target="_new";
...
/************************************************************************************
 ...
 doReasonMuti()     : doReasonMuti ÇÏ´Â ÇÔ¼ö.
...
function doReasonMuti(ServletPath,CheckData,FormName){
    ...
    if( count != 0 ){
        if( !confirm( count + "°³ Ç×¸ñÀ» Á¤¸®ÇÏ½Ã°Ú½À´Ï±î?") ){
            return false;
        }
        js_CenterNewWin2("", "_new", 400, 300);
        frm.target="_new";
...
/************************************************************************************
 ...
 doItemMutiDel()        : doItemMutiDel ÇÏ´Â ÇÔ¼ö.
...
/************************************************************************************
 ...
 doSingleDel()      : SingleDel ÇÏ´Â ÇÔ¼ö.
...
/***************************************************************
  1. ¼³¸í : textareaÀÇ ±ÛÀÚ¼ö¸¦ Ã¼Å©
    2. ÀÔ·ÂÇ×¸ñ(Parameter)
            - txtarea : Textarea Name.
            - charlength : ÀÔ·Â°¡´ÉÇÑ ±ÛÀÚ¼ö
*************************************************************************/
function js_Chkbyte(txtarea, charlength) {
  ...
  for( k = 0; k < ch.length; k++ )  {
    ...
    if ( cnt <= charlength ) {
        ...
        alert('ÇöÀç '+cnt+'byte ÀÔ·ÂÇÏ¼Ì½À´Ï´Ù! \n\nÃÖ´ë '+ charlength + 'byte±îÁö(ÇÑ±Û 2byte) ÀÔ·ÂÇÒ ¼ö ÀÖ½À´Ï´Ù!');
        txtarea.focus();
      return false;
    }
}
...
/************************************************************************************
 js_CheckDigits()       : 3ÀÚ¸®¸¶´Ù ÄÄ¸Ó(,)¸¦ ³Ö¾îÁÖ´Â ÇÔ¼ö

 »ç¿ë¿¹                 : <input ... onkeyup = "js_CheckDigits(this)">
...
js_BeforeYear(chkdate)      : ÇöÀç ³âµµ ÀÌÀüÀÇ ³âµµ ÀÎÁö Ã¼Å©
 »ç¿ë¿¹                             : <input type="text" name="year" onChange="js_BeforeYear(this);">
                                          ==>> (format: "2003-01-11")
*************************************************************************************/
function js_BeforeYear(chkdate){
    if( chkdate.length != 0 ){
        ...
        if(Number(nowDate) < Number(chkdate.value)){
            alert('ÇöÀç ÀÌÀü ³¯Â¥¸¸ ÀÔ·Â°¡´ÉÇÕ´Ï´Ù.\n\n´Ù½Ã È®ÀÎÇÏ½Ã°í ÀÔ·ÂÇØ ÁÖ¼¼¿ä.');
            chkdate.focus();
            return false;
        }else{
            return true;
...
js_AfterYear(chkdate)       : ÇöÀç ³âµµ ÀÌÈÄÀÇ ³âµµ ÀÎÁö Ã¼Å©
 »ç¿ë¿¹                             : <input type="text" name="year" onChange="js_AfterYear(this);">
                                          ==>> (format: "2003-01-11")
*************************************************************************************/
function js_AfterYear(chkdate){
    if( chkdate.length != 0 ){
        ...
        if(Number(nowDate) > Number(chkdate.value)){
            alert('ÇöÀç ÀÌÈÄ ³¯Â¥¸¸ ÀÔ·Â°¡´ÉÇÕ´Ï´Ù.\n\n´Ù½Ã È®ÀÎÇÏ½Ã°í ÀÔ·ÂÇØ ÁÖ¼¼¿ä.');
            chkdate.focus();
            return false;
        }else{
            return true;
...
/*************************************************************************
  1. ¼³¸í : ÁÖ¹Î¹øÈ£ Ã¼Å©.
    2. ÀÔ·ÂÇ×¸ñ(Parameter)
            - preNoRes  : ÁÖ¹Î¹øÈ£ ¾Õ 6ÀÚ¸® °´Ã¼¸í => form.preNoRes
            - postNoRes : ÁÖ¹Î¹øÈ£ µÚ 7ÀÚ¸® °´Ã¼¸í => form.postNoRes
************************************************************************/
...
/************************************************************************************
  js_isBusinessNo(regst_no)     : »ç¾÷ÀÚ µî·Ï¹øÈ£ Ã¼Å©·ÎÁ÷
  »ç¿ë¿¹                            :<input type="text" name="regst_no" size="20"
                                      value="<%=StringUtil.toNNull(VendInfoTt.xcovendemdl.regst_no,"")%>"
                                     mandatory ="0" mandatoryName="»ç¾÷ÀÚµî·Ï¹øÈ£"
...
/*************************************************************************
  1. ¼³¸í : ÁÖ¹Î¹øÈ£,»ç¾÷ÀÚ¹øÈ£ Ã¼Å©.
    2. ÀÔ·ÂÇ×¸ñ(Parameter)
            - obj  : ÀÚ¸®¼ö¿¡ µû¶ó ÁÖ¹Î¹øÈ£,»ç¾÷ÀÚ ¹øÈ£¸¦ Ã¼Å©ÇÑ´Ù.
************************************************************************/
...
function Check_Digit(obj)
{
    ...
    if( result.length != 0 ){
        if( result.length == 13 ){
            ...
            alert('Àß¸øµÈ Çü½ÄÀÇ ¹øÈ£¸¦ ÀÔ·ÂÇÏ¿´½À´Ï´Ù.\nÁÖ¹Î¹øÈ£ 13ÀÚ¸®\n»ç¾÷ÀÚ¹øÈ£ 10ÀÚ¸®');
            return false;
        }
    }
}
...
/*************************************************************************
  1. ¼³¸í : ÁÖ¹Î¹øÈ£,»ç¾÷ÀÚ¹øÈ£ Ã¼Å©. »óÀ§ »ç¾÷¹øÈ£±¸ºÐ¿¡ µû¶ó Ã¼Å©
    2. ÀÔ·ÂÇ×¸ñ(Parameter)
            - obj  : ÀÚ¸®¼ö¿¡ µû¶ó ÁÖ¹Î¹øÈ£,»ç¾÷ÀÚ ¹øÈ£¸¦ Ã¼Å©ÇÑ´Ù.
            - chkval : »ç¾÷¹øÈ£±¸ºÐ
            - fun_gu : »ç¾÷ÀÚ¹øÈ£ µî·Ï ±¸ºÐ
************************************************************************/
...
/************************************************************************************
 ...
 doCopy(ServletPath,CheckData,FormName)       : ¸®½ºÆ®¿¡¼­ ¹®¼­¸¦ º¹»çÇØÁÖ´Â ÇÔ¼ö.
...
function doCopyList(ServletPath,CheckData,FormName){
    ...
    if( count != 0 ){
        if( count != 1 ){
			alert("Ã¼Å©¹Ú½º¸¦ ÇÏ³ª¸¸ ¼±ÅÃÇØÁÖ½Ê½Ã¿ä.");
            return false;
        }
		doCopy(ServletPath);
    }
...
/************************************************************************************
 ...
 doAccount()        : ¼ö·®°ú ´Ü°¡·Î ±Ý¾×À» ±¸ÇÏ´Â ÇÔ¼ö.
...
/************************************************************************************
 ...
 getMean()      : selectbox¿¡¼­ ÄÚµå¸íÀ» °¡Á®¿À´ÂÇÔ¼ö.
...
function getMean( selectbox, changeVal ){
    ...
    var seperator = ":";
    var selectval;
    //?b¾÷Ã¢¿¡¼­µµ ¾µ¼öÀÖ°Ô º¯°æ    2004.10.15  ÀüÀÎ±Ô
    ...
    if (val.length == 1)
    {
        // --¼±ÅÃÇÏ¼¼¿ä ÀÏ°æ¿ì ±×³É ºüÁü    2004.11.19
        return;
    }
...
/************************************************************************************
 ...
 getMean2()     : selectbox¿¡¼­ ÄÚµå¸íÀ» °¡Á®¿À´ÂÇÔ¼ö.¼¼°ü¿ë
...
/************************************************************************************
 ...
 getMean()      : checkbox¿¡¼­ °ªÀ» ÄÁÆ®·ÑÇÏ´ÂÇÔ¼ö.
...
/*--------------------------------------------------
°ø¹éÃ¼Å©°â¿ë ÇÔ¼ö
¿¹)if(document.frmlc.oGanrino.value == "") ´ë½Å
   if(isEmpty(document.frmlc.oGanrino.value)) ¶ó°í ¾²¸é "  "µîÀÇ °ø¹éÀ» Ã¼Å©ÇÒ ¼ö ÀÖÀ½.
--------------------------------------------------*/
...
function checkNum(fld,plusCheck,minorCheck){
    var dst = trimChar(fld.value, ","); //°ª¿¡ ,¸¦ ¸ðµÎ ¾ø¾Ø´Ù
    var intPlus     =   0;
    var intMinor    =   0;
    ...
    if (intPlus>plusCheck){
        alertMessage = "ÀÔ·Â°¡´ÉÇÑ ÀÚ¸´¼ö°¡ ÃÊ°úµÇ¾ú½À´Ï´Ù";
    }
    if (intMinor>minorCheck){
        alertMessage = alertMessage + "\n" + "ÀÔ·Â°¡´ÉÇÑ ÀÚ¸´¼ö°¡ ÃÊ°úµÇ¾ú½À´Ï´Ù";
    }
...
/******************************************************************************
    Description     : ¹®ÀÚÀÇ ±æÀÌ¸¦ °è»êÇÏ¿©ÁÜ. ÇÑ±ÛÀº 2ÀÚ ¿µ¹®,¼ýÀÚ´Â 1ÀÚ
    Parameter       :
    return value    :
...
/******************************************************************************
    Description     : ÇØ´ç ±æÀÌ ÀÌ»óÀÇ ¹®ÀÚ´Â textfield¿¡ µé¾î°¥¼ö ¾ø´Ù
    Parameter       :
    return value    :
    Modification Date    : 2002/12/16
*******************************************************************************/
function textFieldChk(fld,LimitCnt)
{
    ...
    if (intCnt > LimitCnt)
    {
        ...
        alert("ÇöÀç ÀÔ·ÂÇÏ½Å ÇÊµå´Â " + LimitCnt + " ÀÌ»ó ÀÔ·ÂºÒ°¡ ÇÕ´Ï´Ù.\nÀÔ·ÂÇÑ ±ÛÀÚ¼ö´Â :"+intCnt+"\nÁ¦ÇÑµÈ ±ÛÀÚ¼ö ÀÌ»óÀÇ ±ÛÀÚ´Â ÀÚµ¿À¸·Î »èÁ¦ÇÕ´Ï´Ù.\n[**ÇÑ±ÛÇÑ±ÛÀÚ´Â 2±ÛÀÚ·Î Àû¿ë**]");
...
/*
Æ¯¼ö¹®ÀÚ°¡ µé¾î¿À¸é ¸·¾ÆÁÖ´Â ¸Þ¼Òµå
Æ¯¼ö¹®ÀÚ°¡ µé¾î¿À¸é ¸®ÅÏ°ªÀ» true·Î µé¾î¿À°Ô µÈ´Ù....
*/
...
/******************************************************************************
    Description     : ÇÑ±Û ÀÔ·ÂÀ» ¸·´Â ¸Þ¼Òµå
    Parameter       :
    return value    :
    Modification Date    : 2002/12/16
*******************************************************************************/
function codeChk(fld,LimitCnt)
{
    ...
    if (len > LimitCnt)
    {
        alert("ÄÚµåºÎºÐ¿¡´Â " + LimitCnt + "ÀÌ»óÀÇ ±ÛÀÚ¸¦ ÀÔ·ÂÇÒ¼ö ¾ø½À´Ï´Ù");
        fld.value = "";
        fld.focus();
        return;
    }
...
function engChk(fld)
{
    ...
    for (t=0;t< len; t++)
    {
        if (escape((fld.value).substr(t,1)).length > 4)
        {
            alert("ÇÑ±ÛÀ» ÀÔ·ÂÇÏ½Ç ¼ö ¾ø½À´Ï´Ù.");
            fld.value = "";
            fld.focus();
            return;
        }
...
function idCheck(fld,LimitCnt, name )
{
    ...
    if (len > LimitCnt)
    {
        alert( name + " ºÎºÐ¿¡´Â " + LimitCnt + "ÀÌ»óÀÇ ±ÛÀÚ¸¦ ÀÔ·ÂÇÒ¼ö ¾ø½À´Ï´Ù");
        fld.value = "";
        fld.focus();
        return;
    }
    for (t=0;t< len; t++)
    {
        if (escape((fld.value).substr(t,1)).length > 4)
        {
            alert(name + " ºÎºÐ¿¡ ÇÑ±ÛÀ» ÀÔ·ÂÇÏ½Ç¼ö¾ø½À´Ï´Ù.");
            fld.value = "";
            fld.focus();
            return;
        }
...
function formatChk(fld,LimitCnt,name)
{
    ...
    if (len > LimitCnt)
    {
        alert(name + "´Â " + LimitCnt + "ÀÚ¸¸ ÀÔ·Â °¡´ÉÇÕ´Ï´Ù.");
        fld.value = "";
//      fld.focus();
        return;
    }
    for (t=0;t< len; t++)
    {
        if (escape((fld.value).substr(t,1)).length > 4)
        {
            alert( name + "ºÎºÐ¿¡´Â ÇÑ±ÛÀ» ÀÔ·ÂÇÏ½Ç¼ö¾ø½À´Ï´Ù.");
            fld.value = "";
//          fld.focus();
            return;
        }
...
/******************************************************************************
    Description     : ¾÷Ã¼ÄÚµå ¼±ÅÃÈÄ »ç¾÷ÀÚ ¹øÈ£ ±¸ºÐ ÀÚµ¿À¸·Î ³Ö¾îÁÖ´Â ÇÔ¼ö
    Parameter       : »ç¾÷ÀÚ(ÁÖ¹Îµî·Ï¹øÈ£),»ç¾÷ÀÚ¹øÈ£±¸ºÐ ÇÊµå¸í,¹øÈ£ ±¸ºÐ(¼¼°ü À§Å¹ÀÚÀÇ °æ¿ì ÄÚµå°¡ ´Ù¸§)
    return value    :
...
js_BeforeYear(chkdate)      : ÀÌÀüÀÇ ³¯Â¥ ÀÔ·ÂºÒ°¡
 »ç¿ë¿¹                             : <input type="text" name="year" onChange="js_BeforeYear(this);">
                                          ==>> (format: "2003-01-11")
*************************************************************************************/
function js_BeforeDate(chkdate,comdate,mes){
    if( chkdate.value.length != 0 && comdate.value.length != 0){
        ...
        if(chkdate.value < comdate.value){
            alert(mes+' Ç×¸ñ ÀÌÈÄ ³¯Â¥¸¸ ÀÔ·Â°¡´ÉÇÕ´Ï´Ù.\n\n´Ù½Ã È®ÀÎÇÏ½Ã°í ÀÔ·ÂÇØ ÁÖ¼¼¿ä.');
            chkdate.value="";
            chkdate.focus();
            return false;
        }else{
...
js_AfterYear(chkdate)       : ÀÌÈÄ ÀÏÀÚ ÀÔ·Â ºÒ°¡
 »ç¿ë¿¹                             : <input type="text" name="year" onChange="js_AfterYear(this);">
                                          ==>> (format: "2003-01-11")
*************************************************************************************/
function js_AfterDate(chkdate,comdate,mes){
    if( chkdate.value.length != 0 && comdate.value.length != 0 ){
        ...
        if(chkdate.value > comdate.value){
            alert(mes+' Ç×¸ñ ÀÌÀü ³¯Â¥¸¸ ÀÔ·Â°¡´ÉÇÕ´Ï´Ù.\n\n´Ù½Ã È®ÀÎÇÏ½Ã°í ÀÔ·ÂÇØ ÁÖ¼¼¿ä.');
            chkdate.value="";
            chkdate.focus();
            return false;
        }else{
...
js_AfterYear(chkdate)       : ¿À´Ã ÀÌÀü ÀÏÀÚ ÀÔ·Â ºÒ°¡
 »ç¿ë¿¹                             : <input type="text" name="year" onChange="js_AfterYear(this);">
                                          ==>> (format: "2003-01-11")
*************************************************************************************/
function js_toDate(chkdate){
    ...
    if( isDayDiffer < -1 ){
        alert('¿À´Ã ÀÌÀüÀÏÀÚ´Â ÀÔ·ÂÇÏ½Ç¼ö ¾ø½À´Ï´Ù.\n\n´Ù½Ã È®ÀÎÇÏ½Ã°í ÀÔ·ÂÇØ ÁÖ¼¼¿ä.');
        chkdate.value="";
        chkdate.focus();
        return false;
    }
...
js_AfterYear(chkdate)       : À¯È¿±â°£ 1´ÞÈÄ·Î °è»ê ´Ü ¿¬µµ°¡ ¹Ù²ð°æ¿ì 12¿ù31ÀÌ·Î ÀÔ·Â
 »ç¿ë¿¹                             : <input type="text" name="year" onChange="js_AfterYear(this);">
                                          ==>> (format: "2003-01-11")
*************************************************************************************/
...
js_OnlyChar()       : ¹®ÀÚÀÔ·Â¸¸ À¯È¿ÇÏ°Ô ÇÏ´Â ÇÔ¼ö
 »ç¿ë¿¹                             : <input type="text" name="year" onKeypress()="js_ExpDate();">
...
js_EmailCheck()     : ÀÌ¸ÞÀÏÁÖ¼Ò Ã¼Å©
 »ç¿ë¿¹                             : <input type="text" name="year" onBlur()="js_EmailCheck(this);">
...
/************************************************************************************
  js_listSearch()       : ¸®½ºÆ®¿¡¼­ EnterÀ» Ä¡¸é °Ë»öÀ» ÇÑ´Ù.
        ...
        for( i = 0; i < obj.value.length ; i++ ){
            ...
            if( i == 0 ){
                if( temp<65 || (temp>90&&temp<97) || temp>122 ){
                    alert( "ÆÐ½º¿öµåÀÇ Ã¹ÀÚ´Â ¿µ¹®ÀÚÀÌ¿©¾ß ÇÕ´Ï´Ù.");
                    obj.value = '';
                    obj.focus();
                    return false;
                }
            ...
            if( arr[0] == arr[1] && arr[1] == arr[2] && arr[0] == arr[2] ){
                alert( "ÆÐ½º¿öµå´Â °°Àº ¹®ÀÚ°¡ ¼¼¹ø ¿¬¼ÓµÉ¼ö ¾ø½À´Ï´Ù");
                obj.value = '';
                obj.focus();
                return false;
            }
...
/************************************************************************************
  js_getSubCompany_id()     :È¸¿ø»çID µÞºÎºÐÀ» ¾ò´Â ¸Þ¼Òµå
                                isorg = 'N'ÀÌ¸é 'B'¸¦ 'Y'ÀÌ¸é 'A'¸¦ ¿À´Ã³¯Â¥µÚ¿¡ ºÙÀÎ´Ù.
 *************************************************************************************/
...
/***********************************************************************
*  ¼³ ¸í  : Left ¸Þ´º Áß 3 depth ¸Þ´º °ü·Ã
*  »ç¿ë¿¹ :
************************************************************************/
function showhide(num)    {  // 2depth ¸Þ´º¸¦ Å¬¸¯½Ã Å¬¸¯µÇÁö ¾ÊÀº 2depth ¸Þ´ºÀÇ ÇÏÀ§ 3depthÀÇ ¸Þ´º¸¦ ¼û±è
...
*  »ç¿ë¿¹ :
************************************************************************/
function show(num)    {  // 2depth ¸Þ´º¸¦ Å¬¸¯½Ã Å¬¸¯µÈ 2depth ¸Þ´ºÀÇ ÇÏÀ§ 3depth ¸Þ´º¸¦ º¸¿©ÁÜ
  for (i=1; i<=main_cnt; i++)   {
      menu=eval("document.all.block"+i+".style");
        if (num==i) {
          menu.display="block";
...
*  »ç¿ë¿¹ :
************************************************************************/
function change_on(num,onsrc)   {  // on µÇ¾úÀ»´ë on ÀÌ¹ÌÁö·Î ¹Ù²Þ
  if(onimage == num){
...
*  »ç¿ë¿¹ :
************************************************************************/
function change_off(num)    {  // on µÇÁö ¾ÊÀº ÀÌ¹ÌÁöµéÀ» off ÀÌ¹ÌÁö·Î ¹Ù²Þ
  for (i=1; i<=main_cnt; i++)   {
    if(i != num){
...
/***********************************************************************
*  ¼³ ¸í  : ¿ÞÂÊ¸Þ´º¸¦ Å¬¸¯ÇÏ¿© ÇÏºÎ ¸Þ´º¸¦ ÆîÃÄÁö°Ô ÇÑ´Ù.
*  »ç¿ë¿¹ :
************************************************************************/
function fOnLoad() {
 ...
 * °èÁÂÀÌÃ¼¸¦ ÇÑ´Ù.
 *
 * @param vP_NOTI_GOV_CODE ±â°üÄÚµå
 * @param vP_NOTI_COM_CODE ¾÷Ã¼ÄÚµå
 * @param vP_NOTI_DOCUMENT_FUN ¹®¼­ÄÚµå
 * @param vDOCUMENT_NO ¹®¼­¹øÈ£
 * @param vP_GOODS °áÁ¦ »óÇ°¸í
 * @param vP_AMT °Å·¡±Ý¾×(±Ý¾×¸¸ ³Ö¾îÁÖ¼¼¿ä, ex) 1,000 -> 1000 )
 * @param vP_MID »óÁ¡¾ÆÀÌµð (= ±â°üÀÇ PG_ID)
 * @param vP_MNAME »óÁ¡ ÇÑ±Û¸í (= ±â°ü¸í)
 * @param vP_UNAME °áÁ¦ °í°´¼º¸í
 * @param vP_EMAIL »ç¿ëÀÚ e-mail °èÁ¤
 */
...
/******************************************************************************
*  ¼³ ¸í  : À¯°ü±â°ü ÆäÀÌÁö·ÎÀÇ ÀÌµ¿
*  »ç¿ë¿¹ :
//   ParambyName     : 1. orgType   - ±â°üÀÇ Å¸ÀÔ
//
*******************************************************************************/
...
function js_commonSaveExcel(vExcelSize) {
  ...
  // Á¶È¸ µ¥ÀÌÅÍ°¡ 10000(¸¸°Ç)ÀÌ»óÀÎ °æ¿ì
  // ¿¢¼¿·Î ÀúÀåÇÒ ¼ö ¾ø´Ù.
  if (vExcelSize > 10000) {
        alert("Á¶È¸ÇÑ µ¥ÀÌÅÍ°¡ " + vExcelSize + " °Ç ÀÔ´Ï´Ù. \n\n"
        + "¿¢¼¿·Î´Â 10000 °Ç±îÁö¸¸ ÀúÀåµË´Ï´Ù.\n\n"
        + "Á¶È¸Á¶°ÇÀ» ¼³Á¤ÇÏ¿© ´Ù½Ã Á¶È¸ÇØ ÁÖ¼¼¿ä.");
...
/******************************************************************************
    Description     : ÆÄ¶ó¹ÌÅÍ·Î ³Ñ°ÜÁø ÁÖ¼ÒÀÇ ÆË¾÷(popup)
    Parameter       :
    return value    :
*******************************************************************************/
...
/******************************************************************************
    Description     : ÀÔ·ÂÇÑ °³¿ù¼ö ¸¸Å­ ÀÏÀÚ ¼¼ÆÃ - $ADD 200509
    Parameter       : ÃßÃµÀÏÀÚ, À¯È¿±â°£
    return value    : À¯È¿ÀÏÀÚ
                      - °³¿ù¼ö´Â ÄÚµå 3ÀÚ¸®(¿¹ => 1¿ù:'001' ~ 12¿ù:'012', ³â¸»:'999')
*******************************************************************************/
function js_DateForMonth(rec_date, exp_day) {
  var frmMain   = document.forms[0];
  var txtDate   = "";  //ÃßÃµÀÏÀÚ
  var txtField  = "";  //ÇÊµåÀÌ¸§
  var strExpDay = "";  //À¯È¿±â°£ÄÚµå
  var txtMonth  = 0;   //À¯È¿±â°£°³¿ù¼ö
  var _year     = "";
  var _month    = "";
  var _day      = "";
  var rValue    = "";
  ...
  if (rValue == 1) {
    alert('³âÀÌ Àß¸ø µÇ¾ú½À´Ï´Ù');
    return;
  } else if (rValue == 2) {
    alert('¿ùÀÌ Àß¸ø µÇ¾ú½À´Ï´Ù');
    return;
  } else if (rValue == 3) {
    alert('ÀÏÀÌ Àß¸ø µÇ¾ú½À´Ï´Ù');
    return;
  }
...
/******************************************************************************
    Description     : ¼ö½Ä°è»ê¿¡ ÇÊ¿äÇÑ ÇÔ¼ö - $ADD 200509
    Parameter       :
    return value    :
*******************************************************************************/
...
//¿ë    µµ : ÅØ½ºÆ® ÇÊµåÀÇ ºÐ¸®ÀÚ¸¦ Á¦°ÅÇÏ´Â ÇÔ¼ö
//¸Å°³º¯¼ö : ÅØ½ºÆ® ÇÊµå
//»ç ¿ë ¿¹ : onFocus="removeDel(obj.value)"
...
/******************************************************************************
    Description     : ÆÄ¶ó¹ÌÅÍ·Î ³Ñ°ÜÁø ÁÖ¼ÒÀÇ ÇïÇÁ ÆË¾÷(popup)
    Parameter       :
    return value    :
*******************************************************************************/
...
/******************************************************************************
 20060522 : È®ÀåÀÚ¸¦ Ã¼Å©ÇØ¼­ Çã¿ë¿©ºÎ ¸®ÅÏ
*******************************************************************************/
function js_checkFileType(filename){
  var al=new Array('bmp','gif','jpg','jpeg','png','doc','hwp','txt','ppt','xls','pdf','gul','zip','alz'); //Çã¿ëÇÒ È®ÀåÀÚ
//  	alert('filename :'+filename);
  //var tmp=filename.split(".")[1].toLowerCase(); //ÆÄÀÏ¸íÀ» . ·Î ³ª´©¾î ¼Ò¹®ÀÚÈ­
...
function recommendItem(formName, goUrl, width, height,fieldData ) {
  var frmObject=formName;
	...
	*/
	...
	addDataToProperty(property); //Æû¿¡ ÀÖ´Â ÇÊµå ÃëÇÕ
...
/**************************************************
 *
 * ¸ð´Þ ÆË¾÷À» ¶ç¿îµÚ °á°ú¸¦ callback ÇÔ¼ö·Î ¹Þ´Â ÇÔ¼ö
 * callbackÀÌ ÁöÁ¤µÇÁö ¾ÊÀ¸¸é setValue(result)°¡ ±âº» È£Ãâ µÈ´Ù.
 *
 * @param form µ¥ÀÌÅ¸¸¦ ³Ñ±æ form
 * @param url ÆË¾÷À» ¿­ url
 * @param width ÆË¾÷ÀÇ Æø
 * @param height ÆË¾÷ÀÇ ³ôÀÌ
 * @param callback ÆË¾÷À» ´ÝÀº ÈÄ °á°ú¸¦ µ¹·Á¹ÞÀ» callback ÇÔ¼ö
 *
 **************************************************/
...
/*****
  * Form¿¡ ÀÖ´Â °ªÀ» ObjectÀÇ property °ªÀ¸·Î ´ã¾Æ¼­ ¹ÝÈ¯ÇÔ
  *****/
...
//====================================================
// ¸ð´Þ ¶ç¿ï¶§ ÇÊ¿äÇÑ ¸Þ¼Òµå ³¡
//====================================================

//»ç¿ëÀÚ°¡ ÀÔ·ÂÇÑ »çÀÌÁî¸¦ º¸¿©ÁÖ°í ÃÖ´ë ÃÖ¼Ò°ªÀ» º¸¿©ÁØ´Ù.
 ...
 //Enter ÀÌº¥Æ®
 	...
 	if (reg.test(character) || event.keyCode==8 ) {
		if( escape(event.keyCode) != "13") {
			//alert("ÀÔ·ÂÇÑ¹®ÀÚ¿­ Å©±â:"+getBytes(obj.value));
		    ...
		    if(obj.minbyte!=null) { mess+="<br>&nbsp;&nbsp;&nbsp;ÃÖ¼Ò : "+obj.minbyte; realHeight+=hgt; }
		    if(obj.maxbyte!=null) { mess+="<br>&nbsp;&nbsp;&nbsp;ÃÖ´ë : "+obj.maxbyte; realHeight+=hgt; }
		    ...
		    alert('obj.clientHeight:'+obj.clientHeight); //°´Ã¼ ³ôÀÌ
		    alert('obj.clientWidth:'+obj.clientWidth); //°´Ã¼ Æø
		    */
		    /*
...
// 20070221 17:26 °øÁ¾ÇÊ Ãß°¡ ³¡

 /**
 * clipboard¿¡¼­ copyÇßÀ»½Ã ±ÛÀÚ¼ö Ã¼Å©.
 */
  function fnPaste(vEl)
  {
   ...
   if(getBytes(vEl.value+window.clipboardData.getData("Text")) > parseInt(vEl.maxbye) ) {
   	alert('»çÀÌÁî°¡ 483À» ÃÊ°úÇØ¼­ ´õÀÌ»ó ºÙ¿©³Ö±â¸¦ ÇÒ ¼ö ¾ø½À´Ï´Ù.:');
   	return false;
   }
...
//====================================================
// detail ºÎºÐº¹»ç
// @param tbID : copyÇÒ Å×ÀÌºí ¾ÆÀÌµð
// @param targetTbID : copyÀÇ ´ë»óÀÌ µÇ´Â Å×ÀÌºí ¾ÆÀÌµð
// @param tbIDOrg ±âº»À¸·Î »Ñ·ÁÁö´Â Å×ÀÌºí ¾ÆÀÌµð ( »èÁ¦¹öÆ°ÀÌ Ãß°¡µÇ¾î ÀÖÁö ¾ÊÀ½)
//====================================================
...
//xmlhttp·ÎºÎÅÍ µ¥ÀÌÅÍ°¡ ³Ñ¾î¿Ã°æ¿ì
...
//ÄÚµå Ã£´Â ÀÌ¹ÌÁö ¹öÆ° ¾È º¸ÀÌ°ÔÇÏ±â
//readonlyToggleExcept »ç¿ëÀÚ argument »©°í readonly
//ÀÌ¹ÌÁö ¾Èº¸ÀÌ°ÔÇÏ°í
...
/*********************************************************
@author	ryan
sendData()		select box¿¡¼­ µ¥ÀÌÅÍ¸¦ ¼­¹ö·Î º¸³»´Â ÇÔ¼ö

@param source this
@param target µ¥ÀÌÅÍ¸¦ Ãâ·ÂÇÒ select box ID
@param action controller¿Í mappingµÇ´Â url
	...
	var myAjax = $.ajax({
					type : 'POST',
				  	...
				  	success: function(data){
				    	...
				    	var text = document.createTextNode('¼±ÅÃÇÏ¼¼¿ä');
...
/*********************************************************
 masterForm ¿¡ otherFormÀÇ µ¥ÀÌÅÍ¸¦ appendÇØ¼­
 submit()ÇÔ
 *********************************************************/
function submitWithOtherForm( masterForm, otherForm) {
	...
	*/
	//pagingFieldData¿¡ form¿¡ ÀÖ´Â ¿¤¸®¸ÕÆ® Áý°è
	//for(var k=0;k<n;k++) {
...
/**************************************************
 *
 * ¿©·¯°³ÀÇ formÀ» mergeÇÏ¿© submitÇÏ´Â ÇÔ¼ö
 *
 * [»ç¿ë¿¹]
 *  1) ¹Ù·Î submitÇÏ±â
 *     <a href="#" onclick="submitMultipleForm([document.getElementById('form1'), ..., document.getElementById('formN')])">Àü¼Û</a>
 *  2) Å×½ºÆ®¿ëÀ¸·Î º¸³¾ µ¥ÀÌÅ¸ È®ÀÎÇÏ°í submitÇÏ±â
 *     <a href="#" onclick="submitMultipleForm([document.getElementById('form1'), ..., document.getElementById('formN')], true)">Àü¼Û</a>
 *  3) Validation Ã¼Å©ÈÄ º¸³»±â
 *    function sumitForm() {
 ...
 *    }
 *
 *    <a href="#" onclick="submitForm()">Àü¼Û</a>
 *
 * [ÁÖÀÇ»çÇ×]
 *  1) Àü¼ÛÇÒ ¿©·¯ form ³»¿¡ °°Àº nameÀ» °¡Áø <input>ÀÌ³ª <select>, <textarea>°¡ ÀÖÀ» °æ¿ì ¹®Á¦°¡ »ý±â¹Ç·Î nameÀ» Áßº¹µÇÁö ¾Ê°Ô Á¤ÀÇÇØ¾ßÇÑ´Ù
 *
 * @param forms [ÇÊ¼ö], Æû°´Ã¼ÀÇ ¹è¿­, Ã¹¹øÂ° formÀÇ action°ú method·Î submitµÈ´Ù. [form1, form2, ..., formN] ÇüÅÂ·Î Àü´ÞÇÑ´Ù.
 * @param debugEnabled [¼±ÅÃ], debugEnabled = trueÀÌ¸é ÆäÀÌÁö ÇÏ´Ü¿¡ mergeµÈ formÀÇ µ¥ÀÌÅ¸¿Í submit¹öÆ°À» º¼ ¼ö ÀÖ´Ù
 *
 **************************************************/
...
/**************************************************
 *
 * Ã¹¹øÂ° depth¼±ÅÃ½Ã ÇÏÀ§ depth¸¦ ÃÊ±âÈ­ ÇÑ´Ù.
 *
 * targets´Â ['threeCtg.stdCtgNo','fourCtg.stdCtgNo']ÇüÅÂ·Î Àü´ÞÇÑ´Ù.
 *
***************************************************/
 ...
 * @¼³¸í : ±âÁØ³â¿ù ÄÞº¸ ¼ÂÆÃ(ÄÞº¸¸¦ È°¿ëÇÑ ³â,¿ù Ç¥½ÃÇÏ±â)
 *        ÃÖÃÊ ·Îµù½Ã¿£ ¿À´Ã ³¯Â¥¸¦ ±âÁØÀ¸·Î ÇØ¼­ ³â¿ù °ªÀ» ¼³Á¤ÇÏ°í, ³â¿ùÀ» ¼±ÅÃÇÑ ÈÄ
 *        °Ë»ö¹öÆ°À» ´­·¶À» ¶§´Â ¼±ÅÃµÈ °ªÀ¸·Î ¼³Á¤µÈ´Ù.
 * @param : yName - ³âµµ select°´Ã¼ name
 *          mName - ¿ù select°´Ã¼ name
 *          yr    - ÆÄ¶ó¹ÌÅÍ·Î ³Ñ¾î¿Â ³âµµ select°´Ã¼ÀÇ ¼±ÅÃ°ª
 *          mon   - ÆÄ¶ó¹ÌÅÍ·Î ³Ñ¾î¿Â ¿ù select°´Ã¼ÀÇ ¼±ÅÃ°ª
 **********************************************************************/
function setBasicYM(yName, mName, yr, mon){
    //alert('yr :'+yr);
    //alert('mon :'+mon);
    //¿À´ÃÀº ±âÁØÀ¸·Î ³â¿ùÀ» °¡Á®¿Â´Ù.
    var today = new Date();
    var year = today.getYear();
    var month = today.getMonth()+1;
    //alert(today + " : " + year + '³â ' + month + '¿ù');

    //³âµµ ÄÞº¸ ¼ÂÆÃ(5³â ÀüºÎÅÍ ÇöÀç³âµµ±îÁö Ç¥½Ã)
...
/****************************************
 *	@author ryan
 *	ÀÌ¹ÌÁö ¾÷·Îµå ½Ã ÀÌ¹ÌÁöÀÇ È®ÀåÀÚ¸¦ Ã¼Å©ÇÑ´Ù.
 *	jpg(jpeg), gif, png
 *****************************************/
 function checkImgFormat(file){
	...
	{
		 alert("jpg, gif, png ÆÄÀÏ¸¸ Áö¿ø µË´Ï´Ù.");
...
/*****************************************************
 *	@author ryan
 *	ÆÄÀÏ ¾÷·Îµå ½Ã È®ÀåÀÚ¸¦ Ã¼Å©, ½ÇÇà°¡´ÉÇÑ ÆÄÀÏÀÇ ¾÷·Îµå¸¦ ¸·´Â´Ù.
...
/*****************************************************
 *	@author peter
 *	ÆÄÀÏ ¾÷·Îµå ½Ã ¿ë·® Ã¼Å© - xml ÆÄÀÏ ºÒ°¡
 *	»ç¿ë¿¹-> onChange='checkFileSize(this)'
 *******************************************************/
function checkFileSize(obj, maxSize) {
	...
	if (fileSize > maxSize) {
		alert("ÆÄÀÏ¾÷·Îµå Çã¿ë ¿ë·® 10Mbyte¸¦ ÃÊ°úÇÏ¿´½À´Ï´Ù.");
...
/*****************************************************
 *	@author victor
 *	ÀÚ¹Ù ½ºÅ©¸³Æ®¿¡¼­ replaceAllÀ» °¡´ÉÇÏ°Ô ÇØÁÖ´Â function.(3°³Áß ¾Æ¹«°Å³ª »ç¿ë.)
 *	»ç¿ë¿¹-> replace( something.value , "\n", "<br>")
 *******************************************************/
...
/**
* »ç¿ë¹æ¹ý : ÁÖÀÇ => [ div ÀÇ HEIGHT[286px] >= {½ºÅ©·ÎµÉ »óÇ°ÀÌ¹ÌÁö HTML ¿µ¿ªÀÇ ³ôÀÌ:scroll_area_height} ]ÀÏ °æ¿ì¿¡ Á¤»óÀûÀ¸·Î Ç¥½ÃµÊ.
...
*       scroll_snc[0] = '..½ºÅ©·ÎµÉ »óÇ°ÀÌ¹ÌÁö HTML ¿µ¿ª..';
*       ...
*       scroll_snc[n] = '..½ºÅ©·ÎµÉ »óÇ°ÀÌ¹ÌÁö HTML ¿µ¿ª..';
*
*       var paramsObject =  {
*                              scroll_snc : scroll_snc,
*                              scrollwidth_goods: 140,      // scroll ÀÌµ¿³Êºñ ´ÜÀ§
*                              scrollspeed_goods: 5,        // scroll speed ´ÜÀ§ (scrollwidth_goods À» scrollspeed_goods À¸·Î ³ª´« ³ª¸ÓÁö°¡ 0 ÀÌ¾î¾ßÇÔ.)
...
*                            };
*
*       scrollHGoodImages.init(paramsObject);// ½ºÅ©·Ñ °ª ¼³Á¤
*       scrollHGoodImages.startscroll_goods();// ½ºÅ©·Ñ ½ÃÀÛ
*   </script>
* </div>
**/
function ScrollHGoodImages() {

       this.scroll_snc = new Array();     // scroll »óÇ°Area HTML
       this.scrollwidth_goods = 0;        // scroll ÀÌµ¿³Êºñ ´ÜÀ§
       this.total_area_b_goods = 0;       // Ç×¸ñ¼ö
       this.scroll_interval_goods = null; // setInterval Object
       this.scrollspeed_goods = 5;        // scroll speed ´ÜÀ§ (scrollwidth_goods À» scrollspeed_goods À¸·Î ³ª´« ³ª¸ÓÁö°¡ 0 ÀÌ¾î¾ßÇÔ.)
       ...
       this.scrollauto = 'Y';		      //scrollauto : ½Ã°£¸¶´Ù ÀÚµ¿½ºÅ©·Ñ »ç¿ë¿©ºÎ Ã³¸®
       ...
       this.init = function(params) {
	       ...
	       if(params.scrollauto == 'N' ){ //NÀÏ¶§¸¸ ¼ÂÆÃ
...
function js_DecimalNumber(obj)
{
    ...
    if(sFilter)
    {
      ...
      if (event.keyCode == 13){
      	event.returnValue =false;
      // BackSpace, DeleteÅ° °Ë»çÇÏÁö ¾Ê´Â´Ù.
...
* Enter key ÀÔ·Â½Ã ·Î±×ÀÎ ÆûÀ» ¼­¹Ô ÇÑ´Ù.
************************************************/
...
/***************************************
* @author ryan 2008.9.3 ¼öÁ¤
* sendNotice()±¸Çö ÆË¾÷ ¸Þ¼¼Áö Ã¢
****************************************/
...
var checkBoxUtil = {
    ...
    */
    ...
    /*
    * ÀüÃ¼¼±ÅÃ/ÇØÁ¦ ¸¦ µ¿½Ã¿¡ »ç¿ëÇÏ´Â Ã¼Å©¹Ú½ºÀÏ °æ¿ì¿¡ ÀüÃ¼¼±ÅÃ/ÀüÃ¼ÇØÁ¦ ¸¦ ÇÒ °æ¿ì »ç¿ëµÊ.[»ó´Ü¿¡ ÇÏ³ª , ÇÏ´Ü¿¡ ÇÏ³ª ÀÖ´Â °æ¿ì¿¡ ´ëÇØ¼­
    */
    ...
    /*
    * Ã¼Å©µÈ Ã¼Å©¹Ú½º°¡ Á¸ÀçÇÏ´ÂÁö ¿©ºÎ¸¦ ¸®ÅÏÇÑ´Ù.
    *
    * ¸®ÅÏ°ª : true => ¼±ÅÃµÈ Ã¼Å©¹Ú½º°¡ ÀÖÀ½.
    *        false => ¼±ÅÂµÈ Ã¼Å©¹Ú½º°¡ ¾øÀ½.
    */
...
function submitModalForm(frmObject, reloadFlag, passVal) {
    ...
    // window.name ÁöÁ¤Àº publicModal.html ¿¡¼­ ÀÌ¹Ì ÇßÀ¸¹Ç·Î ÇÒ ÇÊ¿ä¾øÀ½
...
function showModalForm(frmObject, goUrl, width, height, callback, fieldData) {
    // ToDo:showDetail ÇÔ¼ö ¸¸µé±â
    // addDataToProperty(property); var result = modalOpen(property); ÈÄ¿¡ callback Function Ã³¸®ÇÏ±â
    ...
    */
    ...
    if(result != null){
        if(result.SUCCESS) {
            ...
            alert('<fmt:message key="errors.common.fail">½ÇÆÐ</fmt:message>');
        }
    }
}
...
//--------------------------------------------------
// IFRAME submit ÈÄ, °á°ú Ã³¸®¸¦ À§ÇÑ ¸ðµâ
//  - 2008/10/18
//  - zag@uzen.net
//--------------------------------------------------
...
/**
* ºäÆ¼G¸¶ÄÏ/¸ð´× LNB Category Å¬¸¯ ½Ã display Á¤ÀÇ
* categoriLeft() ¿¡ ÀÇÇØ È£ÃâµÈ´Ù.
*/
...
// ÇÑ±Û Å°¿öµå encoding 2011.05.19 by inshallah
function goStatUrl(url, code ,target) {
 ...
 if (code=="BMA0201" && url.indexOf("retUrl=")>-1) {
	 ...
	 // KeyWord encodingÀ» À§ÇØ parameters ÀçÁ¶ÇÕ
...
// way : left or right
// obj : »óÇ°À» ±¸¼ºÇÏ°í ÀÖ´Â Element ¸í
// currRowObj : ÇöÀç ¸î ¹øÂ° rowÀÎÁö ÀúÀåÇÏ´Â Element ¸í
// row : ÃÑ rowÀÇ °¹¼ö
// currRow : ÇöÀç À§Ä¡ÇÏ°í ÀÖ´Â row
function fnListWay(way, obj, currRowObj, row){
	var currRow = document.getElementById(currRowObj).value; //ÇöÀç À§Ä¡ÇÏ°í ÀÖ´Â row
	var viewRow = 1; //º¸¿©Áà¾ß ÇÒ row
...
isDate = function (val) {
	...
	/**
	 * 9999-12-31 ³¯Â¥Çü½ÄÀÌ ¸ÂÁö ¾Ê´Ù´Â ¿À·ù°¡ ¹ß»ýÇÏ¿© Ã³¸®
	 */
	if ( matches = val.match(/^(\d{4})[/](\d{2})[/](\d{2})$/) ) {
		...
		alert("³¯Â¥ Çü½ÄÀÌ ¿Ã¹Ù¸£Áö ¾Ê½À´Ï´Ù.\n\nyyyy/MM/dd Çü½ÄÀ¸·Î ÀÔ·ÂÇØ ÁÖ½Ê½Ã¿ä.");
		return false;
	}
}
